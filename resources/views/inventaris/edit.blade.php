@section('title','App Inventaris | Edit Inventaris')
...
<div class="widget has-shadow">
    ...
    <div class="widget-body">
        <form class="needs-validation" novalidate method="post" action="{{route('inventaris.update',$data->id_inventaris)}}" >
            @csrf
            {{method_field('put')}}
            <div class="form-group row d-flex align-items-center mb-5">
                <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Kode Barang</label>
                <div class="col-lg-5">
                    <input type="text" name="kode_inventaris" value="{{$data->kode_inventaris}}" class="form-control" placeholder="Masukkan kode" readonly required>
                </div>
            </div>
            <div class="form-group row d-flex align-items-center mb-5">
                <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Nama Barang</label>
                <div class="col-lg-5">
                    <input type="text" name="nama_inventaris" value="{{$data->nama_inventaris}}" class="form-control" placeholder="Masukkan nama" required>
                </div>
            </div>
            <div class="form-group row d-flex align-items-center mb-5">
            ...
            <div class="form-group row d-flex align-items-center mb-5">
                ...
                <div class="col-lg-5">
                    <input type="number" name="jumlah" value="{{$data->jumlah}}" class="form-control" placeholder="Masukkan jumlah" required>
                </div>
            </div>
            <div class="form-group row d-flex align-items-center mb-5">
                <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Tanggal Ubah</label>
                <div class="col-lg-5">
