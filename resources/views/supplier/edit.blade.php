@section('title','App Inventaris | Edit Supplier')
...
<div class="widget has-shadow">
    ...
    <div class="widget-body">
        <form class="needs-validation" novalidate method="post" action="{{route('supplier.update',$data->id_supplier)}}" >
            @csrf
            {{method_field('put')}}
            <div class="form-group row d-flex align-items-center mb-5">
                <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Kode Supplier</label>
                <div class="col-lg-5">
                    <input type="text" name="kode_supplier" value="{{$data->kode_supplier}}" class="form-control" placeholder="Masukkan kode" readonly required>
                </div>
            </div>
            <div class="form-group row d-flex align-items-center mb-5">
                <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Nama Supplier</label>
                <div class="col-lg-5">
                    <input type="text" name="nama_supplier" class="form-control" value="{{$data->nama_supplier}}" placeholder="Masukkan nama" required>
                </div>
            </div>
            <div class="form-group row d-flex align-items-center mb-5">
                <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Alamat</label>
                <div class="col-lg-5">
                    <input type="text" name="alamat_supplier" class="form-control" value="{{$data->alamat_supplier}}" placeholder="Masukkan alamat" required>
                </div>
            </div>
            <div class="form-group row d-flex align-items-center mb-5">
            ...
            <div class="form-group row d-flex align-items-center mb-5">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" value="{{$data->no_telp}}" name="no_telp" class="form-control" placeholder="Phone number">
                    </div>
                </div>
            </div>
            <div class="text-left">
